    ...
    <Container fluid="md" className=" longitud justify-content-md-center">
      ...
      <div className="container mh-50 Carousel-container">
          ...
          <div className="d-flex flex-column justify-content-center">
              ...
              <Button className="button-banner" variant="primary">Shop Now</Button>
      ...
      <div className="orisontal"> <div className="container mh-50 Mini-container">
        ...
        <h1 className="Text-product"> Product name</h1>
        <h1 className="Text-product"> $150.00</h1></div>
